...
import {COLOR_BACKGROUND, COLOR_PRIMARY, COLOR_WHITE, COMMAND_PRINT_ALL,} from "../../util/BluetoothUtil.ts";
import {RELAY_ATTRIBUTES_REFRESH} from "../../util/ButtonUtil.ts";
...
const RefreshButton = (props: RefreshButtonProps) => {
    ...
    let relayAttr = RELAY_ATTRIBUTES_REFRESH;
